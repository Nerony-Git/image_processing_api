...
var image_path = __importStar(require("../../utilities/image_output_path"));
var images = express_1.default.Router();
images.get("/", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var verify_params, w_response, output_path;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, verify.default.check_params(request.query)];
            case 1:
                verify_params = _a.sent();
                if (verify_params) {
                    response.send(verify_params);
                    return [2 /*return*/];
                }
                w_response = "";
                return [4 /*yield*/, verify.default.output_exist(request.query)];
            case 2:
                if (!((_a.sent()) === false)) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, store_image_output_1.default)(request.query)];
            case 3:
                w_response = _a.sent();
                _a.label = 4;
            case 4:
                ...
                return [4 /*yield*/, image_path.default.get_output_file_path(request.query)];
            case 5:
                output_path = _a.sent();
                if (output_path) {
