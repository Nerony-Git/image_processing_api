...
images.get(
    ...
    async (
        ...
        const verify_params: string | undefined =
            await verify.default.check_params(request.query);
        ...
        const output_path: string | undefined =
            await image_path.default.get_output_file_path(request.query);
        if (output_path) {
